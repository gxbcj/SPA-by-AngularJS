...
define('core/contacts/contactsApp',['angular',
  'ui.router',
  'angular-animate'
  ], function  (angular) {

  var contactsApp = angular.module('uiRouterSample.contacts', [
    'ui.router'
  ]);
      ...
      function ($stateProvider,   $urlRouterProvider) {
        $stateProvider
          ...
          .state('contacts', {
            ...
            // within index.html.
            templateUrl: 'template/contacts/contacts.html',
            ...
            controller: ['$scope', '$state', 'contacts', 'utils','$location',
              function (  $scope,   $state,   contacts,   utils, $location) {
          ...
          .state('contacts.list', {
            ...
            templateUrl: 'template/contacts/contacts.list.html'
          })
          ...
          .state('contacts.detail', {
            ...
            views: {
              ...
              '': {
                templateUrl: 'template/contacts/contacts.detail.html',
          ...
          .state('contacts.detail.item', {
            ...
            views: {
              ...
              '': {
                templateUrl: 'template/contacts/contacts.detail.item.html',
          ...
          .state('contacts.detail.item.edit', {
            views: {
              ...
              '@contacts.detail': {
                templateUrl: 'template/contacts/contacts.detail.item.edit.html',
                controller: ['$scope', '$stateParams', '$state', 'utils',
                  function (  $scope,   $stateParams,   $state,   utils) {
                    $scope.item = utils.findById($scope.contact.items, $stateParams.itemId);
                    $scope.done = function () {
...
define('core/contacts/contactsService',['angular'], function  (angular) {
...
define('common/utils/utilsService',['angular'], function  (angular) {

  var utilService = angular.module('uiRouterSample.utils.service', [
  ]);

  utilService.factory('utils', function () {
    return {
...
define('core/configApp',['angular','ui.router'], 
	function(angular){
...
define('core/app',['angular',
  'core/contacts/contactsApp',
  'core/contacts/contactsService',
  'common/utils/utilsService',
  'core/configApp',
  'ui.router',
  'angular-animate'
  ], function (angular) {
